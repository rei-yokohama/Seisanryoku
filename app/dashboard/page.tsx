...
const services: {
  ...
  { icon: I("M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.54a4.5 4.5 0 00-6.364-6.364L4.5 8.25l4.5 4.5a4.5 4.5 0 006.364 0l1.757-1.757"), label: "連携", href: "/settings/webhooks", description: "Discord・Slack・Chatwork", permissionKey: "settings", accent: "hover:border-violet-400" },
