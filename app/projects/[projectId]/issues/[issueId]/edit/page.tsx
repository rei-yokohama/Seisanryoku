...
export default function IssueEditPage() {
  ...
  if (loading) {
    return (
      <AppShell title="課題編集" subtitle="読み込み中..." projectId={projectId}>
    ...
    <AppShell 
      ...
      subtitle={
        <div className="flex items-center gap-2 text-xs">
          ...
          <Link href={`/projects/${projectId}/issues/${issueId}`} className="hover:underline text-slate-500">{issue.issueKey}</Link>
          <span className="text-slate-400">/</span>
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-5">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-12">
          ...
          <div className="md:col-span-12 border-t border-slate-100 pt-4">
            <div className="text-xs font-extrabold text-slate-600 mb-2">課題の詳細（@ を入力してメンバーに通知：準備中）</div>
