...
蜂のように効率的な工数管理。Googleカレンダーと連携する次世代SaaSアプリケーション。
...
- **Googleカレンダー連携**: 各社員のGoogleカレンダーと双方向で連携
  - 工数エントリをGoogleカレンダーに自動登録
  - Googleカレンダーの予定を取得して表示
- **工数記録**: カレンダー形式で作業時間を記録
- **Googleカレンダー風UI**: 直感的な月表示カレンダー
...
- Googleカレンダーのアクセストークンはブラウザのメモリに保存されます。長時間使用する場合は再認証が必要になる場合があります
